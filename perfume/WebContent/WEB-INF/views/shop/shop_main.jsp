...
<body>
	...
	<section>
		<div class="table-wrapper" style="margin:0 auto; width:70%; text-align: center;">
			<div style="padding-bottom:40px; height:80px;" class="divhover">
				<a class="a1" style="color:#585858;;" href="/perfumeList">ALL</a>
				<a style="margin-left:30px;" class="a1" href="/perfumeListMale">MALE</a>
			...
			<div style="width:100%; height:30px; text-align:right; padding-right:15px;">	
				<form action="/searchPerfume" method=post>					
			...
			<div style="width:100%; height:30px; padding-top:20px; padding-bottom:50px; text-align:right; padding-right:20px;">			
