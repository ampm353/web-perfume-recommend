...
<section style ="margin-top:60px;"></section>
...
<div class = "stepWrap">
	...
	<div class = "div">
		<h4 style="font-weight:500; padding-bottom:10px; border-bottom:2px solid black;  font-size:22px;"><b style="color:black;">하루의 시작</b>을 어떤 향과 함께하고 싶으신가요?</h4>
		<div>
...
<div id = "step2">
	...
	<div class = "div">
		<h4 style="font-weight:500; padding-bottom:10px; border-bottom:2px solid black; font-size:22px;"><b style="color:black;">하루의 대부분</b>을 어떤 향과 보내고 싶으신가요?</h4>
		<div>
...
<div id = "step3">
	...
	<div class = "div">
		<h4 style="font-weight:500; padding-bottom:10px; border-bottom:2px solid black; font-size:22px;"><b style="color:#000000;">하루의 끝</b>을 어떤 향과 마무리하고 싶으신가요?</h4>
		<div>
...
<!-- 
	...
	<div class = "div2">
		...
		<input type = "text" autocomplete="off" id = "view" name = "brand" class = "text" style ="color: black;width: 200px; height:30px; border: 1px solid black; border-bottom-color: #aaa; border-left-color: #777; border-right-color: #ccc; box-sizing: border-box; padding:1px 6px; margin: 0px; margin-left: 10px;" />
