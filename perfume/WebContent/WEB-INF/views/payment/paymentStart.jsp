				...
				<div class="div-80">
					<ul class="accordion accordion-2 checkout mb0">
						<li class="toggler">
							...
							<div class="content">
								...
								<table class="table-borderless to_perfume">
									<tbody>
										<tr>
											<td rowspan="4"><img class="basket_img" alt="Twenty Second" src="/upload/photo/${bl.perfumePhotopath}"></td>
											<td>제품명 : ${bl.perfumeName}</td>
										</tr>
										<tr>
							...
							<div class="content">
								<div class="tabbed-content button-tabs adress-info">
									...
									<div class="contents">
										...
										<h5>배송지 목록 (배송지를 클릭하시면 현재 배송정보로 이동됩니다.)</h5>
										<br>
						...
						<div id="sticky-button" class="row-gapless mb-xs-0 mt48 mb48">
							<input type="hidden" value="${basketList[0].perfumeName }">
							<input type="hidden" value="${basketList[0].perfumeVolume }">
...
function checkOne(atr){
		if($(atr).attr('class')=="check_div"){
			$(atr).addClass("checked_payment");
		}else{
			$(atr).removeClass("checked_payment");
		}
}
//배송지 테이블 삭제
