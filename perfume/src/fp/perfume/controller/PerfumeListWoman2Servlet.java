 ...
 */
@WebServlet(name = "PerfumeListWoman2", urlPatterns = { "/perfumeListWoman2" })
public class PerfumeListWoman2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PerfumeListWoman2Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectListWoman2(reqPage);
