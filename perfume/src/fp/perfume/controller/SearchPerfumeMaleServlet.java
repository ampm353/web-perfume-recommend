 ...
 */
@WebServlet(name = "SearchPerfumeMale", urlPatterns = { "/searchPerfumeMale" })
public class SearchPerfumeMaleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchPerfumeMaleServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectSearchMale(reqPage, selected, inputvalue);
