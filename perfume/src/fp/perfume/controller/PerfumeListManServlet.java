 ...
 */
@WebServlet(name = "PerfumeListMan", urlPatterns = { "/perfumeListMan" })
public class PerfumeListManServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PerfumeListManServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectListMan(reqPage);
