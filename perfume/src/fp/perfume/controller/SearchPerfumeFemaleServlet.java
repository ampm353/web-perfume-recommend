 ...
 */
@WebServlet(name = "SearchPerfumeFemale", urlPatterns = { "/searchPerfumeFemale" })
public class SearchPerfumeFemaleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchPerfumeFemaleServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectSearchFemale(reqPage, selected, inputvalue);
