 ...
 */
@WebServlet(name = "PerfumeListMale", urlPatterns = { "/perfumeListMale" })
public class PerfumeListMaleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PerfumeListMaleServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectListMale(reqPage);
