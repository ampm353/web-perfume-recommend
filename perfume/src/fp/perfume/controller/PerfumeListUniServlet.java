 ...
 */
@WebServlet(name = "PerfumeListUni", urlPatterns = { "/perfumeListUni" })
public class PerfumeListUniServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PerfumeListUniServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectListUni(reqPage);
