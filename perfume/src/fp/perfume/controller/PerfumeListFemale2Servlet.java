 ...
 */
@WebServlet(name = "PerfumeListFemale2", urlPatterns = { "/perfumeListFemale2" })
public class PerfumeListFemale2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PerfumeListFemale2Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectListFemale2(reqPage);
