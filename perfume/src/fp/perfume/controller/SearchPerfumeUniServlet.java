 ...
 */
@WebServlet(name = "SearchPerfumeUni", urlPatterns = { "/searchPerfumeUni" })
public class SearchPerfumeUniServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchPerfumeUniServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pd = service.selectSearchUni(reqPage, selected, inputvalue);
